    ...
    <main style={{ background: BLACK, minHeight: '100vh', fontFamily: 'var(--font-inter), sans-serif' }}>
      ...
      <div style={{ maxWidth: '820px', margin: '0 auto', padding: '5rem 2rem 3rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
          <span style={{ background: 'rgba(74,158,255,0.1)', color: BLUE, fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '0.3rem 0.75rem', borderRadius: '4px' }}>Web Development</span>
          <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.8rem' }}>7 min read</span>
          <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.8rem' }}>February 2026</span>
        </div>
      ...
      <div style={{ maxWidth: '820px', margin: '0 auto', padding: '0 2rem 2rem' }}>
        <div style={{
          ...
          {/* Intro */}
          <p style={{ fontSize: '1.15rem', fontWeight: 500, color: '#111', marginTop: 0, lineHeight: 1.75 }}>
          ...
          <hr style={{ border: 'none', borderTop: '2px solid #f0f0f0', margin: '2.5rem 0' }} />

          {/* Section 1 */}
          <h2 style={{ fontFamily: 'var(--font-grotesk), sans-serif', fontWeight: 700, fontSize: '1.4rem', color: '#111', marginBottom: '1rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <li><strong>No monthly plugin fees.</strong> No Elementor Pro renewal. No WooCommerce extensions. No "premium add-on required" for basic features.</li>
      ...
      {/* CTA */}
      <div style={{ maxWidth: '820px', margin: '0 auto', padding: '3rem 2rem 6rem', textAlign: 'center' }}>
        <div style={{ background: 'linear-gradient(135deg, rgba(74,158,255,0.08) 0%, rgba(74,158,255,0.02) 100%)', border: '1px solid rgba(74,158,255,0.2)', borderRadius: '16px', padding: '3rem 2rem' }}>
          <h2 style={{ fontFamily: 'var(--font-grotesk), sans-serif', fontWeight: 700, fontSize: '1.6rem', color: '#fff', margin: '0 0 1rem' }}>
          ...
          <a href="https://pearllab.io/#contact" style={{ display: 'inline-block', background: BLUE, color: '#fff', fontFamily: 'var(--font-inter)', fontWeight: 600, fontSize: '1rem', padding: '0.875rem 2.5rem', borderRadius: '8px', textDecoration: 'none' }}>
            Get in Touch →
          </a>
        </div>
      </div>
