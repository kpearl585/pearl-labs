...
export default function Footer() {
  return (
    <footer className="px-8 md:px-12 lg:px-20 xl:px-32 py-8 mt-8">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pt-6"
        style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
        <div className="flex items-center gap-6">
          <span className="text-[12px] text-white/20 font-display font-medium tracking-tight">Pearl Labs</span>
          ...
          <div className="flex gap-2">
            {[
              ...
              <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
                className="w-7 h-7 rounded-md flex items-center justify-center text-white/14 hover:text-white/35 transition-colors duration-200">
