      ...
      <svg viewBox="0 0 400 400" fill="none" aria-hidden="true">
        <defs>
          <linearGradient id="sd-edge" x1="0" y1="0" x2="1" y2="0">
            ...
            <stop offset="50%" stopColor="#2E6BFF" stopOpacity="1" />
        ...
        {/* connecting lines */}
        <g stroke="rgba(46,107,255,0.15)" strokeWidth="1">
        ...
        {nodes.map((n) => (
          <g key={n.label} transform={`translate(${n.x}, ${n.y})`}>
            ...
            <rect
              ...
              rx="6"
              fill="#0A0F1E"
              stroke={n.active ? '#2E6BFF' : 'rgba(46,107,255,0.25)'}
              strokeWidth="1"
            />
            <text
              x="0"
